...
#elif __ANDROID__ || __IOS__ || __MACCATALYST__
using GenericCulture = System.String;
using Microsoft.UI.Xaml.Data;
#else
using Microsoft.UI.Xaml.Data;
...
namespace Nventive.View.Converters
{
	...
	public class FromDateToPrettyStringConverter : IValueConverter, IAutoRefreshConverter
	{
		...
		public object Convert(object value, Type targetType, object parameter, string language)
		{
			...
			{
#if __NETSTANDARD__
				return Formatter.Format(elapsed.Value, language, Mode);
#else
				return Formatter.Format(elapsed.Value, new GenericCulture(language), Mode);
#endif
			}
