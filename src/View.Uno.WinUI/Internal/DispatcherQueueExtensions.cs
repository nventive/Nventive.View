...
namespace Nventive.View
{
	...
	internal static class DispatcherQueueExtensions
	{
		...
		internal static Task RunTaskAsync(this DispatcherQueue dispatcher, DispatcherQueuePriority priority = DispatcherQueuePriority.Normal, DispatcherQueueHandler handler = default)
		{
			...
			return RunAsync(dispatcher, priority, handler);
		}

		internal static Task RunAsync(this DispatcherQueue dispatcher, DispatcherQueuePriority priority, DispatcherQueueHandler handler = default)
		{
