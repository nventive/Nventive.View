#if WINDOWS_UWP || __ANDROID__ || __IOS__ || __WINDOWS10_0_18362_0__
using System;
...
#endif
#if __ANDROID__ && !WINUI || __IOS__ && !WINUI
	...
	public class GroupedCollectionBehavior
	{
		...
		class Builder
		{
			...
			public void UpdateSource()
			{
				...
				if (source == null)
				{
#if WINDOWS_UWP || __WINDOWS10_0_18362_0__
...
#if WINUI
						_listViewBase is ListView legacyListViewBase
#else
						_listViewBase is _ListViewLegacy legacyListViewBase
#endif
						)
					{
