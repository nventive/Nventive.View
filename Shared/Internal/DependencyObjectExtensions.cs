	...
	internal static partial class DependencyObjectExtensions
	{
		...
		internal static IObservable<DependencyPropertyChanged<TValue>> ObservePropertyChanged<TValue>(this DependencyObject instance, DependencyProperty property)
		{
...
#if __WINDOWS10_0_18362_0__ || WINDOWS_UWP
			...
			observer = Observable.Create<DependencyPropertyChanged<TValue>>(obs => 
			{
				...
				{
					obs.OnNext(new DependencyPropertyChanged<TValue>
					{
		...
		/// </returns>
		internal static DependencyObject FindParent(this _DependencyObject dependencyObject, Func<_DependencyObject, bool> predicate)
		{
		...
		internal static T FindFirstParent<T>(this _DependencyObject element, bool includeCurrent = true)
			where T :
#if __ANDROID__ || __IOS__ || __WASM__ || __MACOS__ || __MACCATALYST__ || NETSTANDARD2_0
			class,
#endif
			_DependencyObject
		{
